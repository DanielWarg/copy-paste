...
export const Transcripts: React.FC<TranscriptsProps> = () => {
    ...
    const handleUploadComplete = (transcriptId: number) => {
    ...
    const handleTranscriptReady = (transcriptId: number, transcript: any) => {
        // Transcript is ready - refresh list to show it
        setTimeout(() => {
            setRefreshTrigger(prev => prev + 1);
        }, 500);
    };
